...
// eslint-disable-next-line
const sanFransiscoImage = require('./assets/san-fransisco.jpg');
// eslint-disable-next-line
const cancunImage = require('./assets/cancun.jpg');
    ...
    return (
        <Content className="home" style={{ backgroundImage: `url(${mapBackground})` }}>
            ...
            <div className="home__cta-section">
                ...
                <Paragraph>Helping you make the best decisions in renting last minute locations.</Paragraph>
                <Link
